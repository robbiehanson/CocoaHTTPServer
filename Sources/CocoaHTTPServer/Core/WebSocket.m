...
+ (BOOL)isWebSocketRequest:(HTTPMessage *)request
{
	...
	HTTPLogTrace2("%@", (isWebSocket ? @"YES" : @"NO"));
...
+ (BOOL)isVersion76Request:(HTTPMessage *)request
{
	...
	HTTPLogTrace2("%@", (isVersion76 ? @"YES" : @"NO"));
...
+ (BOOL)isRFC6455Request:(HTTPMessage *)request
{
	...
	HTTPLogTrace2("%@", (isRFC6455 ? @"YES" : @"NO"));
...
- (id)initWithRequest:(HTTPMessage *)aRequest socket:(GCDAsyncSocket *)socket
{
	...
	if ((self = [super init]))
	{
		if (HTTP_LOG_VERBOSE)
		{
			...
			HTTPLogVerbose("Request Headers:\n%@", temp);
		}
...
- (void)sendResponseHeaders
{
	...
	if (HTTP_LOG_VERBOSE)
	{
		...
		HTTPLogVerbose("Response Headers:\n%@", temp);
	}
...
{
	HTTPLogTrace2("socketDidDisconnect:withError: %@", error);
